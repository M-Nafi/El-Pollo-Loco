class World {
    ...
    /**
     * Initializes the World object with a canvas and keyboard.
     * Sets up the canvas 2D context, the canvas element, and the keyboard object.
     * Sets the world reference for the status bar endboss.
     * Starts the main game loop by calling the draw, setWorld, and run methods.
     * Also starts the main game sound and registers it with the global audio handler.
