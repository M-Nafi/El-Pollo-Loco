class StatusbarCoin extends DrawableObject {
     ...
     *
     * Calls the superclass constructor, loads the images for the coin status bar
     * and sets the x and y coordinates, width and height of the status bar.
     * Then it calls the setPercentage method to set the percentage of the status
     * bar to 0.
     */
    constructor() {
        super();
